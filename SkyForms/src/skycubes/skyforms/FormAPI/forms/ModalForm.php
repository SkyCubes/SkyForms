...
namespace skycubes\skyforms\FormAPI\forms;
...
class ModalForm extends Form{
	...
	public function __construct(string $title, string $content, string $yesButton = "gui.yes", string $noButton = "gui.no", Closure $onSubmit){
